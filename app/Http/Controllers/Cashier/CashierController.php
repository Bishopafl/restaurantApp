...
class CashierController extends Controller
{
    ...
    public function orderFood(Request $request){
        ...
        if (!$sale) {
            $user = Auth::user();// access user auth 
            $userid = Auth::id();// access user auth 
            $sale = new Sale();
    ...
    public function getSaleDetailsByTable($table_id) {
        ...
        if ($sale) {
            ...
            $html .= "No sale details found for selected table";
        }
        return $html;
    }
    ...
    private function getSaleDetails($sale_id) {
        ...
        <table class="table table-stripped table-dark">
            ...
            foreach ($saleDetails as $saleDetail) {
                ...
                $decreaseButton = '<button class="btn btn-danger btn-sm btn-decrease-quantity disable">-</button>';
    ...
    // Request is there to access data from ajax
    public function deleteSaleDetail(Request $request){
        // find the record in the db of the sale and price
        // then delete them
        ...
        // Check if there is any sale details with the sale id
        $saleDetails = SaleDetail::where('sale_id', $sale_id)->first();
        if ($saleDetail) {
            $html = $this->getSaleDetails($sale_id);
        } else {
            $html .= "No Sale Details found for the selected table.";
        }
        return $html;
    }
