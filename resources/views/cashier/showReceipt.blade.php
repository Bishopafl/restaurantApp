...
<body>
    <div id="wrapper">
        <div id="receipt-header">
            <h3 id="restaurant-name">Noah & Avas Restaurant</h3>
            <p>Address: 123 Lane Dr</p>
            <p>Foo, BR 1234</p>
            <p>Tel: 123-xxx-xxxx</p>
        ...
        <div id="buttons">
            ...
            <a href="">
                <button class="btn btn-print" type="button" onclick="window.print(); return false;">Print Reciept</button>
            </a>
        </div>
    </div>
</body>
